...
class LightUNet(L.LightningModule):
    ...
    def validation_step(self,batch,batch_idx):
        ...
        logger = self.task.get_logger()
        logger.report_scalar('val','loss',loss.item(),iteration=self.current_epoch)
        logger.report_scalar('val','dice',dice.item(),iteration=self.current_epoch)
        logger.report_scalar('val','iou',iou.item(),iteration=self.current_epoch)
        logger.report_scalar('val','precision',precision.item(),iteration=self.current_epoch)
        logger.report_scalar('val','recall',recall.item(),iteration=self.current_epoch)
